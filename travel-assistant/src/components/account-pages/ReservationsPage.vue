    ...
    <div v-for="(trip, index) in trips" :key="index">
      ...
      <div v-show="trip.showDetails" class="subheaders-container">
        ...
        <div v-show="trip.activeSubheader === 'travel'" class="card">
          ...
          <p>You will travel by plane, from X to Y</p>
        </div>
        ...
        <div v-show="trip.activeSubheader === 'venues'" class="card">
          ...
          <p>The will visit venues X, Y and Z.</p>
        </div>
...
const trips = ref([
  { date: '10.12.2024', showDetails: false, activeSubheader: '' },
  { date: '10.06.2024', showDetails: false, activeSubheader: '' },
